...
<body class="size-1520 primary-color-orange background-white ">
    ...
    <header class="grid">
        ...
        <div class="stud_form">
            <div class="btn_pos">
                <form method="post">
                   <center> 
                    ...
                    <a href="add_subject"><input type="button" class="btn btn-large btn-primary" value="Register new" name="butAdd" style="font-size: 18px;"/></a>
                    </div>
                    </center> 
                </form>
            </div><br><br>
                ...
                <center> 
                    <table class="table table-bordered">
                            <thead>
                                ...
                                <th style="text-align: center;">Subject Year</th>
         ...
         if($key !="")
             $sql_sel=mysqli_query($conn,"SElECT * FROM subject_info WHERE 'Subject Name'  like '%$key%'");
         else
              $sql_sel=mysqli_query($conn,"SELECT * FROM  subject_info");
         ...
         ?>
          <tr>
            <td><?php echo $row['Subject code'];?></td>
            <td><?php echo $row['Subject Name'];?></td>
            <td><?php echo $row['Total marks'];?></td>
            <td><?php echo $row['Teacher Name'];?></td>
            <td><?php echo $row['Subject_year'];?></td>                      
            <td><a href="?tag=student_entry&opr=upd&rs_id=<?php echo $row['stu_id'];?>" title="Update"><img style="-webkit-box-shadow: 0px 0px 0px 0px rgba(50, 50, 50, 0.75);-moz-box-shadow:    0px 0px 0px 0px rgba(50, 50, 50, 0.75);box-shadow:         0px 0px 0px 0px rgba(50, 50, 50, 0.75);" src="updateimg.png" height="20" alt="Update" /></a></td>
            <td><a href="?tag=view_students&opr=del&rs_id=<?php echo $row['stu_id'];?>" title="Delete"><img style="-webkit-box-shadow: 0px 0px 0px 0px rgba(50, 50, 50, 0.75);-moz-box-shadow:    0px 0px 0px 0px rgba(50, 50, 50, 0.75);box-shadow:         0px 0px 0px 0px rgba(50, 50, 50, 0.75);" src="deleteimg.png" height="20" alt="Delete" /></a></td>
