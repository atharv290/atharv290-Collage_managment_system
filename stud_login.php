...
<html lang="en-US">
  ...
  <div class="login1">
        <center>
            ...
            <input type="username" class="form-control" name="name" id="floatingInput" placeholder="Enrollment No">
...
function msg1() {
    ...
    $sql = mysqli_query($conn, "SELECT * FROM student_info WHERE enrollment_no='$uname' AND login_password='$pwd'");
    $cout = mysqli_num_rows($sql);
    
    if ($cout > 0) {
        $row = mysqli_fetch_array($sql);
                header("location: stud_profile.php?enrollment_no=$uname");
