                ...
                <center>
                    ...
                    <div class="btn_pos_search">
                        <input type="submit" class="btn btn-primary btn-large" name="btnsearch" value="Search"
                            style="font-size: 18px;" />&nbsp;&nbsp;
                        <a href="add_stud.php"><input type="button" class="btn btn-large btn-primary"
                    ...
                    <table>
                        <thead>
                            ...
                            if ($key != "")
                                ...
                                $sql_sel = mysqli_query($conn, "SELECT * FROM student_info");
                            ...
                            while ($row = mysqli_fetch_array($sql_sel)) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><a href="update_student.php?enrollment_no=<?php echo $row['enrollment_no']; ?>"
                                            title="Update"><img
                                                ...
                                                src="updateimg.png" height="20" alt="Update" /></a></td>
                                    <td style="text-align: center;"><a href="delete_stud.php?enrollment_no=<?php echo $row['enrollment_no']; ?>"
                                            title="Delete"><img
                                                style="-webkit-box-shadow: 0px 0px 0px 0px rgba(50, 50, 50, 0.75);-moz-box-shadow:    0px 0px 0px 0px rgba(50, 50, 50, 0.75);box-shadow:         0px 0px 0px 0px rgba(50, 50, 50, 0.75);"
